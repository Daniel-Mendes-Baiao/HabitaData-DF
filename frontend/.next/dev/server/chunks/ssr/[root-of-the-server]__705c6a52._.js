...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$react$2f$dist$2f$esm$2f$deckgl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/node_modules/@deck.gl/react/dist/esm/deckgl.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$layers$2f$dist$2f$esm$2f$column$2d$layer$2f$column$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ColumnLayer$3e$__ = __turbopack_context__.i("[project]/frontend/node_modules/@deck.gl/layers/dist/esm/column-layer/column-layer.js [app-ssr] (ecmascript) <export default as ColumnLayer>");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$layers$2f$dist$2f$esm$2f$scatterplot$2d$layer$2f$scatterplot$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ScatterplotLayer$3e$__ = __turbopack_context__.i("[project]/frontend/node_modules/@deck.gl/layers/dist/esm/scatterplot-layer/scatterplot-layer.js [app-ssr] (ecmascript) <export default as ScatterplotLayer>");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$aggregation$2d$layers$2f$dist$2f$esm$2f$heatmap$2d$layer$2f$heatmap$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__HeatmapLayer$3e$__ = __turbopack_context__.i("[project]/frontend/node_modules/@deck.gl/aggregation-layers/dist/esm/heatmap-layer/heatmap-layer.js [app-ssr] (ecmascript) <export default as HeatmapLayer>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$AnalyticsContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/context/AnalyticsContext.tsx [app-ssr] (ecmascript)");
...
function UrbanMap() {
    const { state, setAnoSelecionado } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$context$2f$AnalyticsContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAnalytics"])();
    ...
    const [mode, setMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('valuation');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadData() {
            setLoading(true);
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["geospatialAPI"].getRegions3D(state.anoSelecionado);
                setData(res || []);
            } catch (err) {
    ...
    const layers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (data.length === 0) return [];
        const valuationLayer = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$layers$2f$dist$2f$esm$2f$column$2d$layer$2f$column$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ColumnLayer$3e$__["ColumnLayer"]({
            id: 'valuation-layer',
            data,
            diskResolution: 12,
            radius: 250,
            ...
            getFillColor: (d)=>d.cagr_medio_pct > 5 ? [
                    16,
                    185,
                    129,
                    200
            ...
            getElevation: (d)=>Math.max(0, d.cagr_medio_pct * 100),
            visible: mode === 'valuation'
        });
        const priceLayer = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$layers$2f$dist$2f$esm$2f$column$2d$layer$2f$column$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ColumnLayer$3e$__["ColumnLayer"]({
            id: 'price-layer',
            data,
            radius: 300,
            extruded: true,
            ...
            getElevation: (d)=>(d.valor_m2_medio || 0) * 0.1,
            visible: mode === 'price'
        });
        const infraLayer = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$layers$2f$dist$2f$esm$2f$scatterplot$2d$layer$2f$scatterplot$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__ScatterplotLayer$3e$__["ScatterplotLayer"]({
            id: 'infra-layer',
            data,
            pickable: true,
            opacity: 0.8,
            ...
            getRadius: (d)=>(d.score_infra || 0) * 10,
            getFillColor: [
                245,
                158,
                11,
        ...
        const crimeLayer = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$aggregation$2d$layers$2f$dist$2f$esm$2f$heatmap$2d$layer$2f$heatmap$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__HeatmapLayer$3e$__["HeatmapLayer"]({
            id: 'crime-heatmap',
            data,
            getPosition: (d)=>[
                    d.longitude,
            ...
            getWeight: (d)=>d.indice_criminalidade || 0,
            radiusPixels: 60,
            intensity: 1,
            threshold: 0.05,
            visible: mode === 'crime'
        });
        const mobilityLayer = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$aggregation$2d$layers$2f$dist$2f$esm$2f$heatmap$2d$layer$2f$heatmap$2d$layer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__HeatmapLayer$3e$__["HeatmapLayer"]({
            id: 'mobility-heatmap',
            data,
            getPosition: (d)=>[
                    d.longitude,
            ...
            getWeight: (d)=>10 - (d.distancia_metro_km || 10),
            radiusPixels: 40,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$deck$2e$gl$2f$react$2f$dist$2f$esm$2f$deckgl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2d$map$2d$gl$2f$dist$2f$esm$2f$exports$2d$maplibre$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
                        mapLib: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$maplibre$2d$gl$2f$dist$2f$maplibre$2d$gl$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"],
                        mapStyle: MAP_STYLE
                    }, void 0, false, {
                        fileName: "[project]/frontend/src/app/page.tsx",
                        lineNumber: 136,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ModeButton, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                        ...
                                        children: Array.from({
                                            length: 16
                                        }, (_, i)=>2010 + i).map((year)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: year,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__705c6a52._.js.map