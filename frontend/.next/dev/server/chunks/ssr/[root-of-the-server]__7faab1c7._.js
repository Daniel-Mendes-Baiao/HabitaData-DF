...
"[project]/frontend/src/app/properties/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PropertyExplorer() {
    const [imovelId, setImovelId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const handleSearch = async (e)=>{
        ...
        setData(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["propertiesAPI"].getDetails(parseInt(imovelId, 10));
            setData(res);
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7faab1c7._.js.map