...
"[project]/frontend/src/app/discovery/temporal/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Plot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/frontend/node_modules/react-plotly.js/react-plotly.js [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    ...
    loading: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/frontend/src/app/discovery/temporal/page.tsx",
            lineNumber: 11,
            columnNumber: 20
...
function TemporalGrowth() {
    ...
    const [metric, setMetric] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('preco_medio');
    const [viewType, setViewType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('idx');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TemporalGrowth.useEffect": ()=>{
            async function fetchData() {
                setLoading(true);
                try {
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analysisAPI"].getGrowthIndices();
                    const fetchedData = res.data || [];
                    setData(fetchedData);
                    if (fetchedData.length > 0) {
                        const regions = Array.from(new Set(fetchedData.map({
                            "TemporalGrowth.useEffect.fetchData.regions": (d)=>d.nome_regiao
                        }["TemporalGrowth.useEffect.fetchData.regions"])));
    ...
    const regions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TemporalGrowth.useMemo[regions]": ()=>Array.from(new Set(data.map({
                "TemporalGrowth.useMemo[regions]": (d)=>d.nome_regiao
            }["TemporalGrowth.useMemo[regions]"])))
    }["TemporalGrowth.useMemo[regions]"], [
        data
    ]);
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TemporalGrowth.useMemo[chartData]": ()=>{
            if (!data.length) return [];
            const metricKey = `${metric}_${viewType}`;
            const filteredData = selectedRegioes.length > 0 ? data.filter({
                "TemporalGrowth.useMemo[chartData]": (d)=>selectedRegioes.includes(d.nome_regiao)
            }["TemporalGrowth.useMemo[chartData]"]) : data;
            const visibleRegions = Array.from(new Set(filteredData.map({
                "TemporalGrowth.useMemo[chartData].visibleRegions": (d)=>d.nome_regiao
            }["TemporalGrowth.useMemo[chartData].visibleRegions"])));
            return visibleRegions.map({
                "TemporalGrowth.useMemo[chartData]": (reg)=>{
                    const regData = filteredData.filter({
                        "TemporalGrowth.useMemo[chartData].regData": (d)=>d.nome_regiao === reg
                    }["TemporalGrowth.useMemo[chartData].regData"]);
                    return {
                        x: regData.map({
                            "TemporalGrowth.useMemo[chartData]": (d)=>d.ano
                        }["TemporalGrowth.useMemo[chartData]"]),
                        y: regData.map({
                            "TemporalGrowth.useMemo[chartData]": (d)=>d[metricKey]
                        }["TemporalGrowth.useMemo[chartData]"]),
                        type: 'scatter',
                        mode: 'lines+markers',
                        name: reg,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: METRICS.map((m)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: regions.map((reg)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HighlightCard, {
                                        icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TrendingUp$3e$__["TrendingUp"], {
                                            size: 14
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/src/app/discovery/temporal/page.tsx",
...
_s(TemporalGrowth, "0tORDEu0vim5MpY9WkyruAzzhkA=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "TemporalGrowth");
__turbopack_context__.k.register(_c2, "HighlightCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_src_45da0d81._.js.map