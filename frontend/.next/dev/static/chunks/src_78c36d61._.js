...
function PropertyExplorer() {
    _s();
    const [imovelId, setImovelId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const handleSearch = async (e)=>{
        ...
        setData(null);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["propertiesAPI"].getDetails(parseInt(imovelId, 10));
            setData(res);
        } catch (err) {
...
//# sourceMappingURL=src_78c36d61._.js.map